...
function Checkbox2(props) {
  return /* @__PURE__ */ jsx3(CheckboxContainer, __spreadProps(__spreadValues({}, CheckboxContainer), { children: /* @__PURE__ */ jsx3(CheckboxIndicator, { children: /* @__PURE__ */ jsx3(Check, { weight: "bold" }) }) }));
}
...
function Toast2({ title, content, open, setOpen }) {
  return /* @__PURE__ */ jsxs4(ToastProvider, { children: [
    /* @__PURE__ */ jsxs4(ToastContainer, { open, onOpenChange: setOpen, children: [
      ...
      /* @__PURE__ */ jsx5(ToastDescription, { children: content })
    ] }),
